...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @if ($class_T->status === 'Senior High School'||$class_T->status === 'Junior High School')
        <div class="row mt-5">
        ...
        <div class="row mt-5">
            <div class="col-md-4">
                <a href="{{route('summative1',[$t->id,$class_T->id])}}"  class="btn btn-success">Summative 1</a>
            </div>
            <div class="col-md-4">
                <a href="{{route('summative',[$t->id,$class_T->id])}}"  class="btn btn-success">Summative 2</a>
            </div>
            <div class="col-md-4">
