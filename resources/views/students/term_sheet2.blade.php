...
<div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-9">
                <p class=" mb-2 text-gray-800"style=" font-size:12px;"> Session: {{$term->session}} {{$term->name}} </h2>
            </div>
            <div class="col-3" style="float:right;">
                <p class=" mb-2 text-gray-800 "style=" font-size:12px;">Class: {{$class_T->name}} </h5>
            </div>
