...
<div class="container-fluid">
        ...
        @if ($class_->status == 'Junior High School')
           ...
           <tr>
            ...
            <tr>
               ...
               <th>Total</th>
               @for ($i = 1; $i <= 10; $i++)
               <td>{{ round(App\Student::subject_total_jGT($i,$class_->id,$term->id))}} </td>
               @endfor
               <td>{{$sum_total}}</td>
               <td>{{$min_t}}</td>
               <td>{{$min_t_per}}</td>
           ...
           <tr>
               ...
               <th>Max Score</th>
               @for ($i = 1; $i <= 10; $i++)
               <td>{{round(App\Student::max_score_jGT($i,$term->id,$class_->id))}}</td>
               @endfor
           ...
           <tr>
               ...
               <th>Min Score</th>
               @for ($i = 1; $i <= 10; $i++)
                    <td>{{round(App\Student::min_score_jGT($i,$term->id,$class_->id))}}</td>
               @endfor
 ...
 <tr>
                        ...
                        <th>Class Average</th>
                        @for ($i = 1; $i <= 10; $i++)
                        <td>{{App\Student::average(App\Student::subject_total_jGT($i,$class_->id,$term->id),App\Student::checkNoJStudent($i,$term->id,$class_->id,7))}}</td>
                        @endfor
                    ...
                    <tr>
                        ...
                        @for ($i = 1; $i <= $cnt; $i++)
                        <td>{{round(App\Student::average_per(App\Student::subject_total_jGT($i,$class_->id,$term->id),($GT_score  * App\Student::checkNoJStudent($i,$term->id,$class_->id,7))))}}</td>
                        @php
                        ...
                        @endphp
                        @endfor
                        <td>{{App\Student::average($cl_av, App\Student::checkNoJStudent($i,$term->id,$class_->id,7))}}</td>
                        <td>Class Average</td> 
                    ...
                    <tr>
                        ...
                        <th>Remarks</th>
                        @for ($i = 1; $i <= $cnt; $i++)
                        <td>{{App\Student::h_grade(App\Student::average_per(App\Student::subject_total_jGT($i,$class_->id,$term->id),($GT_score  * App\Student::checkNoJStudent($i,$term->id,$class_->id,7))),$grades)}}</td>
                        @endfor
       ...
       @elseif($class_->status == 'Junior High School')
       <table  class="table table-striped table-bordered m-0  text-default" style="width:100%">
           <thead class="header">
               <th class="rotate">S/No</th>
               <th >Name</th>
