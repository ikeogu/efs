...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo mr-auto">
        ...
        {{-- <a href="/"><img src="img/logo.png" alt="" class="img-fluid" height="50" width="auto"></a> --}}
      </div>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>EmeraldField Schools 2020 - {{date('Y')}} </span></strong>. All Rights Reserved
      </div>
      <div class="credits">
