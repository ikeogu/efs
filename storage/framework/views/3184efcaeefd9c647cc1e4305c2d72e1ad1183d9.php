            ...
            <div class="col-12 table-responsive">
                 <?php if($class_->status == 'Junior High School'): ?>
                    ...
                    <tr>
                        ...
                        <th>Class Average</th>
                        <?php for($i = 1; $i <= $cnt; $i++): ?>
                        <td><?php echo e(App\Student::average(App\Student::subject_total_jcat1($i,$class_->id,$term->id),$students->count())); ?></td>
                        <?php endfor; ?>
                    ...
                    <tr>
                        ...
                        <?php for($i = 1; $i <= $cnt; $i++): ?>
                        <td><?php echo e(round(App\Student::average_per(App\Student::subject_total_jcat1($i,$class_->id,$term->id),($TCA_score * $students->count())))); ?></td>
                        <?php
                            $cl_av += App\Student::average_per(App\Student::subject_total_jcat1($item->id,$class_->id,$term->id),($TCA_score * $students->count()));
                        ?>
                        <?php endfor; ?>
                    ...
                    <tr>
                        ...
                        <th>Remarks</th>
                        <?php for($i = 1; $i <= $cnt; $i++): ?>
                        <td><?php echo e(App\Student::h_grade(App\Student::average_per(App\Student::subject_total_jcat1($i,$class_->id,$term->id),($TCA_score * $students->count())),$grades)); ?></td>
                        <?php endfor; ?>
                ...
                <table  class="table table-striped table-bordered m-0  text-default" style="width:100%">
                    ...
                    <tr>
                        ...
                        <th>Class Average</th>
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(App\Student::average(App\Student::subject_total_cat1($item->id,$class_->id,$term->id),$students->count())); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <th>Class Performance (%)</th>
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(round(App\Student::average_per(App\Student::subject_total_cat1($item->id,$class_->id,$term->id),($TCA_score * $students->count())))); ?></td>
                        <?php
                    ...
                    <tr>
                        ...
                        <th>Remarks</th>
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(App\Student::h_grade(App\Student::average_per(App\Student::subject_total_cat1($item->id,$class_->id,$term->id),($TCA_score * $students->count())),$grades)); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ishledpg/efs/resources/views/teacher/cat1_broadsheet.blade.php ENDPATH**/ ?>