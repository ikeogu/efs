    ...
    <!-- details table -->
        <section class="container my-5">
            <div class="d-flex justify-content-end">
                <a href="<?php echo e(route('ds',[$student->id,$term->id,$class_->id])); ?>" type="button" class="btn btn-outline-danger"><i class="fa fa-download" aria-hidden="true"></i>ExportToPDF</a>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.tdashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ishledpg/efs/resources/views/teacher/summative_sheet.blade.php ENDPATH**/ ?>