...
<div class="container-fluid" > 
     <div class="d-flex justify-content-end">
        <a href="<?php echo e(route('dsum2',[$term->id,$class_->id])); ?>" type="button" class="btn btn-outline-danger"><i class="fa fa-download" aria-hidden="true"></i>ExportTOPDF</a>
    </div> 
    <!--<form>-->
    <!--    <input type = "button" value = "Print" onclick = "window.print()" id="printPageButton"  class="btn btn-success btn-block btn-sm"/>-->
    <!--</form>-->
   <div class="card">
        <div class="card-header bg-success text-white">SUMMATIVE TEST II / <?php echo e($class_->name); ?> /<?php echo e($class_->description); ?>    / <?php echo e($term->name); ?> / <?php echo e($term->session); ?></div>
        <div class="card-body">
                ...
                <tbody>  
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     ...
                     <tr>
                        ...
                        <td><?php echo e(App\Student::subject_total($item->id,$class_->id,$term->id)); ?> </td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td>Max Score</td>
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(App\Student::max_score($item->id,$class_->id,$term->id)); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td>Min Score</td>
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <td><?php echo e(App\Student::min_score($item->id,$class_->id,$term->id)); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(App\Student::average(App\Student::subject_total($item->id,$class_->id,$term->id),App\Student::checkNoStudent($term->id,$class_->id,$item->id,1))); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td>Subject Average (%)</td>
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(round(App\Student::average_per(App\Student::subject_total($item->id,$class_->id,$term->id),($SMT_score * App\Student::checkNoStudent($term->id,$class_->id,$item->id,1))))); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td>Remarks</td>
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(App\Student::grade(App\Student::average_per(App\Student::subject_total($item->id,$class_->id,$term->id),($SMT_score * App\Student::checkNoStudent($term->id,$class_->id,$item->id,1))),$grades)); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ishledpg/efs/resources/views/results/summative.blade.php ENDPATH**/ ?>