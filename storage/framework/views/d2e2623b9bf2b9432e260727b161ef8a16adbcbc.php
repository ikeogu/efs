      ...
      <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                <a type="button" href="https://efs.ishlp.com/api/students_in_term2/<?php echo e($item->term_id); ?>/class/<?php echo e($item->s5_class_id); ?>" class="btn btn-success btn-block">View</a>
                </td>
            </tr>
