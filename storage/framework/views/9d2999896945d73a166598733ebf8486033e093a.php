...
<?php $__env->startSection('title', 'MSC BROADSHEET'); ?>

<?php $__env->startSection('content'); ?>

<div class="container-fluid">
    <div class="card">
    <div class="card-header bg-success text-capitalize text-white">M.S.C <?php echo e($class_->name); ?>|   <?php echo e($class_->description); ?>  | <?php echo e($term->name); ?>|  <?php echo e($term->session); ?></div>
        <div class="card-body">
                 ...
                 <?php if($class_->status == 'Junior High School'): ?>
                    ...
                    <tr>
                        ...
                        <?php if($item->term_id == $term->id && $item->s5_class_id == $class_->id): ?>
                           <?php if(!in_array($item->status,$status)): ?>
                               <?php
                                 $sum = App\SubjectMark::where('term_id',$term->id)->where('s5_class_id',$class_->id)->where('student_id',$student->id)->where('status',$item->status)->sum('MSC');
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <th>Total</th>
                        <?php for($i = 1; $i <= 10; $i++): ?>
                        <td><?php echo e(round(App\Student::subject_total_jMSC($i,$class_->id,$term->id))); ?> </td>
                        <?php endfor; ?>
                    ...
                    <tr>
                        ...
                        <th>Max Score</th>
                        <?php for($i = 1; $i <= 10; $i++): ?>
                        <td><?php echo e(round(App\Student::max_score_jMSC($i,$class_->id,$term->id))); ?></td>
                        <?php endfor; ?>
                    ...
                    <tr>
                        ...
                        <th>Min Score</th>
                        <?php for($i = 1; $i <= 10; $i++): ?>
                             <td><?php echo e(round(App\Student::min_score_jMSC($i,$class_->id,$term->id))); ?></td>
                        <?php endfor; ?>
                    ...
                    <tr>
                        ...
                        <th>Class Average</th>
                        <?php for($i = 1; $i <= 10; $i++): ?>
                        <td><?php echo e(App\Student::average(App\Student::subject_total_jMSC($i,$class_->id,$term->id),App\Student::checkNoStudent($term->id,$class_->id,$item->id,5))); ?></td>
                        <?php endfor; ?>
                    ...
                    <tr>
                        ...
                        <?php for($i = 1; $i <= $cnt; $i++): ?>
                        <td><?php echo e(round(App\Student::average_per(App\Student::subject_total_jMSC($i,$class_->id,$term->id),($TCA_score * App\Student::checkNoStudent($term->id,$class_->id,$item->id,5))))); ?></td>
                        <?php
                            $cl_av += App\Student::average_per(App\Student::subject_total_jMSC($item->id,$class_->id,$term->id),($TCA_score * App\Student::checkNoStudent($term->id,$class_->id,$item->id,5)))
                        ?>
                        <?php endfor; ?>
                    ...
                    <tr>
                        ...
                        <th>Remarks</th>
                        <?php for($i = 1; $i <= $cnt; $i++): ?>
                        <td><?php echo e(App\Student::h_grade(App\Student::average_per(App\Student::subject_total_jMSC($i,$class_->id,$term->id),($TCA_score * App\Student::checkNoStudent($term->id,$class_->id,$item->id,5))),$grades)); ?></td>
                        <?php endfor; ?>
                ...
                <table  class="table table-striped table-bordered m-0  text-default" style="width:100%">
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td><?php echo e(App\Student::subject_total_msc($item->id,$class_->id,$term->id)); ?> </td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e($sum_total); ?></td>
                        <td><?php echo e($min_t); ?></td>
                        <td><?php echo e($min_t_per); ?></td>
                    ...
                    <tr>
                        ...
                        <th>Max Score</th>
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(App\Student::max_score_msc($item->id,$class_->id,$term->id)); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <th>Min Score</th>
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <td><?php echo e(App\Student::min_score_msc($item->id,$class_->id,$term->id)); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <th>Class Average</th>
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(App\Student::average_(App\Student::subject_total_msc($item->id,$class_->id,$term->id),$term->id,$class_->id,$item->id,4)); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <th>Class Performance (%)</th>
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(round(App\Student::average_per(App\Student::subject_total_msc($item->id,$class_->id,$term->id),($TCA_score  * App\Student::checkNoStudent($term->id,$class_->id,$item->id,4))))); ?></td>
                        <?php
                            $cl_av += App\Student::average_per(App\Student::subject_total_msc($item->id,$class_->id,$term->id),($TCA_score  * App\Student::checkNoStudent($term->id,$class_->id,$item->id,4)));
                        ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <th>Remarks</th>
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(App\Student::h_grade(App\Student::average_per(App\Student::subject_total_msc($item->id,$class_->id,$term->id),($TCA_score  * App\Student::checkNoStudent($term->id,$class_->id,$item->id,4))),$grades)); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ishledpg/efs/resources/views/results/msc.blade.php ENDPATH**/ ?>