...
<section class="container my-5">
    ...
    <!--<a href="<?php echo e(route('dcat1',[$student->id,$term->id,$class_->id])); ?>" type="hidden" class="btn btn-outline-success"><i class="fa fa-download" aria-hidden="true"></i>Download</a>-->
    </div>
    <div class="d-flex justify-content-center "><img src="<?php echo e(asset('img/logo2.png')); ?>" height="80" width="auto"></div>
            ...
            <table class="table-sm table table-bordered table-hover main-result-table text-nowrap">
                ...
                <tbody>
                    ...
                    <?php if($item->term_id == $term->id && $item->s5_class_id == $class_->id): ?>
                         ...
                         <td><?php echo e(round(App\Student::c1_jmax_score($item->status,$class_->id,$term->id))); ?></td> 
                        <td><?php echo e(App\Student::average(App\Student::jsubAver($item->status,$class_->id,$term->id),$users->count())); ?></td>
            ...
            <table class="table-sm table table-bordered table-hover main-result-table text-nowrap">
                ...
                <tbody>
                    ...
                    ?> 
                     ...
                     <td><?php echo e(App\Student::c1_max_score($item->subject_id,$class_->id,$term->id)); ?></td> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.tdashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ishledpg/efs/resources/views/teacher/cat1.blade.php ENDPATH**/ ?>