...
<body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
              ...
              <li class="nav-item">
                    ...
                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="<?php echo e(route('ASS')); ?>">
                                <i class="fas fa-fw fa-chart-area"></i>
                                <span> Post Assignment</span></a>
                            <a class="collapse-item" href="<?php echo e(route('MA')); ?>">Posted Assigments</a>
              ...
              <?php endif; ?>
              <li class="nav-item">
              <a class="nav-link" href="<?php echo e(route('ComB')); ?>">
                  <i class="fas fa-fw fa-chart-area"></i>
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('sub_point')); ?>">
                    <i class="fas fa-fw fa-setting-o"></i>
  ...
  <!-- Page Wrapper -->
    ...
    </html><?php /**PATH /home/chiboy/lampstack-8.0.5-0/apache2/htdocs/efs/resources/views/layouts/tdashboard.blade.php ENDPATH**/ ?>