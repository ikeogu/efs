...
<?php $__env->startSection('title', 'Student Result C.A.T 1'); ?>
...
<div class="container-fluid">
    ...
    <form>
      <input type = "button" value = "Print" onclick = "window.print()" id="printPageButton"  class="btn btn-success  btn-sm"/>
        ...
        <a href="<?php echo e(route('dcat1_bs',[$term->id,$class_->id])); ?>" type="button" class="btn btn-outline-danger btn-sm"><i class="fa fa-download" aria-hidden="true"></i>ExportTOPDF</a>
    </div> 
    <div class="card">
    <div class="card-header bg-success text-capitalize text-white">C.A.T 1 <?php echo e($class_->name); ?>|   <?php echo e($class_->description); ?>  | <?php echo e($term->name); ?>|  <?php echo e($term->session); ?></div>
        <div class="card-body">
                 ...
                 <?php if($class_->status == 'Junior High School'): ?>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <th>Total</th>
                        <?php for($i = 1; $i <= 10; $i++): ?>
                        <td><?php echo e(round(App\Student::subject_total_jcat1($i,$class_->id,$term->id))); ?> </td>
                        <?php endfor; ?>
                    ...
                    <tr>
                        ...
                        <th>Max Score</th>
                        <?php for($i = 1; $i <= 10; $i++): ?>
                        <td><?php echo e(round(App\Student::max_score_jcat1($i,$class_->id,$term->id))); ?></td>
                        <?php endfor; ?>
                    ...
                    <tr>
                        ...
                        <th>Min Score</th>
                        <?php for($i = 1; $i <= 10; $i++): ?>
                             <td><?php echo e(round(App\Student::min_score_jcat1($i,$class_->id,$term->id))); ?></td>
                        <?php endfor; ?>
                    ...
                    <tr>
                        ...
                        <th>Class Average</th>
                        <?php for($i = 1; $i <= 10; $i++): ?>
                        <td><?php echo e(App\Student::average(App\Student::subject_total_jcat1($i,$class_->id,$term->id),App\Student::checkNoJStudent($i,$term->id,$class_->id,2))); ?></td>
                        <?php endfor; ?>
                    ...
                    <tr>
                        ...
                        <?php for($i = 1; $i <= 10; $i++): ?>
                        <td><?php echo e(round(App\Student::average_per(App\Student::subject_total_jcat1($i,$class_->id,$term->id),($TCA_score * App\Student::checkNoJStudent($i,$term->id,$class_->id,2))))); ?></td>
                    ...
                    <tr>
                        ...
                        <th>Remarks</th>
                        <?php for($i = 1; $i <= 10; $i++): ?>
                        <td><?php echo e(App\Student::h_grade(App\Student::average_per(App\Student::subject_total_jcat1($i,$class_->id,$term->id),($TCA_score * App\Student::checkNoJStudent($i,$term->id,$class_->id,2))),$grades)); ?></td>
                        <?php endfor; ?>
                ...
                <table  class="table table-striped table-bordered m-0  text-default" style="width:100%">
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td><?php echo e(App\Student::subject_total_cat1($item->id,$class_->id,$term->id)); ?> </td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e($sum_total); ?></td>
                        <td><?php echo e($min_t); ?></td>
                        <td><?php echo e($min_t_per); ?></td>
                    ...
                    <tr>
                        ...
                        <th>Max Score</th>
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(App\Student::max_score_cat1($item->id,$class_->id,$term->id)); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <th>Min Score</th>
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <td><?php echo e(App\Student::min_score_cat1($item->id,$class_->id,$term->id)); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <th>Class Average</th>
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(App\Student::average_(App\Student::subject_total_cat1($item->id,$class_->id,$term->id),$term->id,$class_->id,$item->id,2)); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <th>Class Performance (%)</th>
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(round(App\Student::average_per(App\Student::subject_total_cat1($item->id,$class_->id,$term->id),($TCA_score  * App\Student::checkNoStudent($term->id,$class_->id,$item->id,2))))); ?></td>
                        <?php
                            $cl_av += App\Student::average_per(App\Student::subject_total_cat1($item->id,$class_->id,$term->id),($TCA_score  * App\Student::checkNoStudent($term->id,$class_->id,$item->id,2)));
                        ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <th>Remarks</th>
                        <?php $__currentLoopData = $subject->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(App\Student::h_grade(App\Student::average_per(App\Student::subject_total_cat1($item->id,$class_->id,$term->id),($TCA_score  * App\Student::checkNoStudent($term->id,$class_->id,$item->id,2))),$grades)); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chiboy/lampstack-8.0.5-0/apache2/htdocs/efs/resources/views/results/cat1_broadsheet.blade.php ENDPATH**/ ?>