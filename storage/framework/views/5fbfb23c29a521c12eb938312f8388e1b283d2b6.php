            ...
            <div class="col-12 table-responsive">
                 <?php if($class_->status == 'Junior High School'): ?>
                    ...
                    <tr>
                        ...
                        <th>Class Average</th>
                        <?php for($i = 1; $i <= $cnt; $i++): ?>
                        <td><?php echo e(App\Student::average(App\Student::subject_total_jcat1($i,$class_->id,$term->id),App\Student::checkNoStudent($term->id,$class_->id,$item->id,2))); ?></td>
                        <?php endfor; ?>
                    ...
                    <tr>
                        ...
                        <?php for($i = 1; $i <= $cnt; $i++): ?>
                        <td><?php echo e(round(App\Student::average_per(App\Student::subject_total_jcat1($i,$class_->id,$term->id),($TCA_score * App\Student::checkNoStudent($term->id,$class_->id,$item->id,2))))); ?></td>
                        <?php
                    ...
                    <tr>
                        ...
                        <th>Remarks</th>
                        <?php for($i = 1; $i <= $cnt; $i++): ?>
                        <td><?php echo e(App\Student::h_grade(App\Student::average_per(App\Student::subject_total_jcat1($i,$class_->id,$term->id),($TCA_score * App\Student::checkNoStudent($term->id,$class_->id,$item->id,2))),$grades)); ?></td>
                        <?php endfor; ?>
