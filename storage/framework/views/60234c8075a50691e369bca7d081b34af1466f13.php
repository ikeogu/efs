...
<?php $__env->startSection('tboard'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-5">
            <div class="col-md-3">
                <a href="<?php echo e(route('summative_ct1',[$t->id,$class_T->id])); ?>"  class="btn btn-success">Summative 1</a>
            </div>
            <div class="col-md-3">
                <a href="<?php echo e(route('summative_ct',[$t->id,$class_T->id])); ?>"  class="btn btn-success">Summative 2</a>
            </div>
            <div class="col-md-3">
...
<?php echo $__env->make('layouts.tdashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chiboy/lampstack-8.0.5-0/apache2/htdocs/efs/resources/views/class/classStudent2.blade.php ENDPATH**/ ?>