        ...
        <div class="">
           ...
           <table  class="table table-striped table-bordered table-condensed" style="width:100%">
              ...
              <tr>
                           ...
                           <td>Class Average</td>
                            <?php $__currentLoopData = $data['subject']->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <td><?php echo e(App\Student::average_(App\Student::subject_total_GT($item->id,$data['class_']->id,$data['term']->id),$data['term']->id,$data['class_']->id,$item->id,4)); ?></td>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                           ...
                           <td>Class Performance (%)</td>
                            <?php $__currentLoopData = $data['subject']->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <td><?php echo e(round(App\Student::average_per(App\Student::subject_total_GT($item->id,$data['class_']->id,$data['term']->id),($TCA_score  * App\Student::checkNoStudent($data['term']->id,$data['class_']->id,$item->id,4))))); ?></td>
                            <?php
                                $cl_av += App\Student::average_per(App\Student::subject_total_GT($item->id,$data['class_']->id,$data['term']->id),($TCA_score  * App\Student::checkNoStudent($data['term']->id,$data['class_']->id,$item->id,4)));
                            ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                           ...
                           <td>Remarks</td>
                            <?php $__currentLoopData = $data['subject']->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <td><?php echo e(App\Student::h_grade(App\Student::average_per(App\Student::subject_total_GT($item->id,$data['class_']->id,$data['term']->id),($TCA_score  * App\Student::checkNoStudent($data['term']->id,$data['class_']->id,$item->id,4))),$data['grades'])); ?></td>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home/chiboy/lampstack-8.0.5-0/apache2/htdocs/efs/resources/views/pdf/cat2_broadsheet.blade.php ENDPATH**/ ?>