            ...
            <div class="col-12 table-responsive">
                 <?php if($class_->status == 'Junior High School'): ?>
                    ...
                    <tr>
                        ...
                        <th>Class Average</th>
                        <?php for($i = 1; $i <= $cnt; $i++): ?>
                        <td><?php echo e(App\Student::average(App\Student::subject_total_jcat2($i,$class_->id,$term->id),App\Student::checkNoJStudent($i,$term->id,$class_->id,3))); ?></td>
                        <?php endfor; ?>
                    ...
                    <tr>
                        ...
                        <?php for($i = 1; $i <= $cnt; $i++): ?>
                        <td><?php echo e(round(App\Student::average_per(App\Student::subject_total_jcat2($i,$class_->id,$term->id),($TCA_score * App\Student::checkNoJStudent($i,$term->id,$class_->id,3))))); ?></td>
                        <?php
                            $cl_av += App\Student::average_per(App\Student::subject_total_jcat2($item->id,$class_->id,$term->id),($TCA_score * App\Student::checkNoJStudent($i,$term->id,$class_->id,3)))
                        ?>
                        <?php endfor; ?>
                    ...
                    <tr>
                        ...
                        <th>Remarks</th>
                        <?php for($i = 1; $i <= $cnt; $i++): ?>
                        <td><?php echo e(App\Student::h_grade(App\Student::average_per(App\Student::subject_total_jcat2($i,$class_->id,$term->id),($TCA_score * App\Student::checkNoJStudent($i,$term->id,$class_->id,3))),$grades)); ?></td>
                        <?php endfor; ?>
...
<?php echo $__env->make('layouts.tdashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ishledpg/efs/resources/views/teacher/cat2_broadsheet.blade.php ENDPATH**/ ?>