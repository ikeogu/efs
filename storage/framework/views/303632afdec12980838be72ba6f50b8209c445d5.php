...
<body>
    ...
    <div class=" bg-success text-capitalize text-white">GT broadSheet <?php echo e($data['class_']->name); ?>|   <?php echo e($data['class_']->description); ?>  | <?php echo e($data['term']->name); ?>|  <?php echo e($data['term']->session); ?></div>
        ...
        <table  class="table-striped table-bordered table-condensed">
                ...
                <tr>
                    ...
                    <?php $__currentLoopData = $data['subject_status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php elseif($sta == 3): ?>
                         ...
                         <?php elseif($sta == 5): ?>
                            <th class="rotate" scope="col"><div><span>C.C.A</span></div></th>
                        <?php elseif($sta == 6): ?>
          ...
          <tbody>
                ...
                <tr>
                    ...
                    <?php if($item->term_id == $data['term']->id && $item->s5_class_id == $data['class_']->id): ?>
                        <?php if(!in_array($item->status,$status)): ?>
                            <?php
                                $sum = App\SubjectMark::where('term_id',$data['term']->id)->where('s5_class_id',$data['class_']->id)->where('student_id',$student->id)->where('status',$item->status)->sum('GT');
                ...
                <tr>
                    ...
                    <td>Total</td>
                    <?php for($i = 1; $i <= 10; $i++): ?>
                    <td><?php echo e(round(App\Student::subject_total_jGT($i,$data['class_']->id,$data['term']->id))); ?> </td>
                    <?php endfor; ?>
                ...
                <tr>
                    ...
                    <td>Max Score</td>
                    <?php for($i = 1; $i <= 10; $i++): ?>
                    <td><?php echo e(round(App\Student::max_score_jGT($i,$data['term']->id,$data['class_']->id))); ?></td>
                    <?php endfor; ?>
                ...
                <tr>
                    ...
                    <td>Min Score</td>
                    <?php for($i = 1; $i <= 10; $i++): ?>
                            <td><?php echo e(round(App\Student::min_score_jGT($i,$data['term']->id,$data['class_']->id))); ?></td>
                    <?php endfor; ?>
                ...
                <tr>
                    ...
                    <td>Class Average</td>
                    <?php for($i = 1; $i <= 10; $i++): ?>
                    <td><?php echo e(App\Student::average(App\Student::subject_total_jGT($i,$data['class_']->id,$data['term']->id),App\Student::checkNoJStudent($i,$data['term']->id,$data['class_']->id,7))); ?></td>
                    <?php endfor; ?>
                ...
                <tr>
                    ...
                    <?php for($i = 1; $i <= $cnt; $i++): ?>
                    <td><?php echo e(round(App\Student::average_per(App\Student::subject_total_jGT($i,$data['class_']->id,$data['term']->id),($TCA_score  * App\Student::checkNoJStudent($i,$data['term']->id,$data['class_']->id,7))))); ?></td>
                    <?php
                        $cl_av += App\Student::average_per(App\Student::subject_total_jGT($item->id,$data['class_']->id,$data['term']->id),($TCA_score  * App\Student::checkNoJStudent($i,$data['term']->id,$data['class_']->id,7)));
                    ?>
                    <?php endfor; ?>
                ...
                <tr>
                    ...
                    <td>Remarks</td>
                    <?php for($i = 1; $i <= $cnt; $i++): ?>
                    <td><?php echo e(App\Student::h_grade(App\Student::average_per(App\Student::subject_total_jGT($i,$data['class_']->id,$data['term']->id),($TCA_score  * App\Student::checkNoJStudent($i,$data['term']->id,$data['class_']->id,7))),$data['grades'])); ?></td>
                    <?php endfor; ?>
       ...
       <table  class="table-striped table-bordered m-0 table-condensed">
           ...
           <tr>
            ...
            <tr>
               ...
               <td><?php echo e(App\Student::subject_total_GT($item->id,$data['class_']->id,$data['term']->id)); ?> </td>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               <td><?php echo e($sum_total); ?></td>
               <td><?php echo e($min_t); ?></td>
               <td><?php echo e($min_t_per); ?></td>
           ...
           <tr>
               ...
               <td>Max Score</td>
               <?php $__currentLoopData = $data['subject']->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <td><?php echo e(App\Student::max_score_GT($item->id,$data['class_']->id,$data['term']->id)); ?></td>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
           ...
           <tr>
               ...
               <td>Min Score</td>
               <?php $__currentLoopData = $data['subject']->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <td><?php echo e(App\Student::min_score_GT($item->id,$data['class_']->id,$data['term']->id)); ?></td>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          ...
          <tr>
                        ...
                        <td>Class Average</td>
                        <?php $__currentLoopData = $data['subject']->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(App\Student::average_(App\Student::subject_total_GT($item->id,$data['class_']->id,$data['term']->id),$data['term']->id,$data['class_']->id,$item->id,7)); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td>Class Performance (%)</td>
                        <?php $__currentLoopData = $data['subject']->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(round(App\Student::average_per(App\Student::subject_total_GT($item->id,$data['class_']->id,$data['term']->id),($TCA_score  * App\Student::checkNoStudent($data['term']->id,$data['class_']->id,$item->id,7))))); ?></td>
                        <?php
                            $cl_av += App\Student::average_per(App\Student::subject_total_GT($item->id,$data['class_']->id,$data['term']->id),($TCA_score  * App\Student::checkNoStudent($data['term']->id,$data['class_']->id,$item->id,7)));
                        ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td>Remarks</td>
                        <?php $__currentLoopData = $data['subject']->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(App\Student::grade(App\Student::average_per(App\Student::subject_total_GT($item->id,$data['class_']->id,$data['term']->id),($TCA_score  * App\Student::checkNoStudent($data['term']->id,$data['class_']->id,$item->id,7))),$data['grades'])); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home/chiboy/lampstack-8.0.5-0/apache2/htdocs/efs/resources/views/pdf/grandTotal.blade.php ENDPATH**/ ?>