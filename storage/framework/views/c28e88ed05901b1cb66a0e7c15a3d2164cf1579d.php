...
<body>
    ...
    <div class=" bg-success text-capitalize text-white">C.A.T 1 <?php echo e($data['class_']->name); ?>|   <?php echo e($data['class_']->description); ?>  | <?php echo e($data['term']->name); ?>|  <?php echo e($data['term']->session); ?></div>
    <?php if($data['class_']->status == 'Junior High School'): ?>
        ...
        <table  class="table-striped table-bordered table-condensed">
          ...
          <tbody>
                ...
                <tr>
                    ...
                    <?php if($item->term_id == $data['term']->id && $item->s5_class_id == $data['class_']->id): ?>
                        <?php if(!in_array($item->status,$status)): ?>
                            <?php
                                $sum = App\SubjectMark::where('term_id',$data['term']->id)->where('s5_class_id',$data['class_']->id)->where('student_id',$student->id)->where('status',$item->status)->sum('CAT1');
                ...
                <tr>
                    ...
                    <td>Total</td>
                    <?php for($i = 1; $i <= 10; $i++): ?>
                    <td><?php echo e(round(App\Student::subject_total_jCAT1($i,$data['class_']->id,$data['term']->id))); ?> </td>
                    <?php endfor; ?>
                ...
                <tr>
                    ...
                    <th>Max Score</th>
                    <?php for($i = 1; $i <= 10; $i++): ?>
                    <td><?php echo e(round(App\Student::max_score_jCAT1($i,$data['term']->id,$data['class_']->id))); ?></td>
                    <?php endfor; ?>
                ...
                <tr>
                    ...
                    <th>Min Score</th>
                    <?php for($i = 1; $i <= 10; $i++): ?>
                            <td><?php echo e(round(App\Student::min_score_jCAT1($i,$data['term']->id,$data['class_']->id))); ?></td>
                    <?php endfor; ?>
                ...
                <tr>
                    ...
                    <td>Class Average</td>
                    <?php for($i = 1; $i <= 10; $i++): ?>
                    <td><?php echo e(App\Student::average(App\Student::subject_total_jCAT1($i,$data['class_']->id,$data['term']->id),App\Student::checkNoJStudent($i,$data['term']->id,$data['class_']->id,2))); ?></td>
                    <?php endfor; ?>
                ...
                <tr>
                    ...
                    <?php for($i = 1; $i <= $cnt; $i++): ?>
                    <td><?php echo e(round(App\Student::average_per(App\Student::subject_total_jCAT1($i,$data['class_']->id,$data['term']->id),($TCA_score  * App\Student::checkNoJStudent($i,$data['term']->id,$data['class_']->id,2))))); ?></td>
                    <?php
                        $cl_av += App\Student::average_per(App\Student::subject_total_jCAT1($item->id,$data['class_']->id,$data['term']->id),($TCA_score  * App\Student::checkNoJStudent($i,$data['term']->id,$data['class_']->id,2)));
                    ?>
                    <?php endfor; ?>
                    <td><?php echo e(App\Student::average($cl_av, App\Student::checkNoJStudent($i,$data['term']->id,$data['class_']->id,2))); ?></td>
                ...
                <tr>
                    ...
                    <td>Remarks</td>
                    <?php for($i = 1; $i <= $cnt; $i++): ?>
                    <td><?php echo e(App\Student::h_grade(App\Student::average_per(App\Student::subject_total_jCAT1($i,$data['class_']->id,$data['term']->id),($TCA_score  * App\Student::checkNoJStudent($i,$data['term']->id,$data['class_']->id,2))),$data['grades'])); ?></td>
                    <?php endfor; ?>
       ...
       <?php else: ?>
             <?php
               ...
               $no_of_subject = 0;
            ?>   
       <table  class="table table-striped table-bordered m-0 table-condensed">
           <thead class="header">
               <tr>
                    <th scope="col">#</th>
                    <th class="rotated-text" scope="col"><div><span>Name</span></div></th>
                    ...
                    <th class="rotated-text" scope="col"><div><span><?php echo e($item->name); ?><</span></div></th>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
           ...
           <tr>
            ...
            <tr>
               ...
               <td><?php echo e(App\Student::subject_total_CAT1($item->id,$data['class_']->id,$data['term']->id)); ?> </td>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               <td><?php echo e($sum_total); ?></td>
               <td><?php echo e($min_t); ?></td>
               <td><?php echo e($min_t_per); ?></td>
           ...
           <tr>
               ...
               <td>Max Score</td>
               <?php $__currentLoopData = $data['subject']->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <td><?php echo e(App\Student::max_score_CAT1($item->id,$data['class_']->id,$data['term']->id)); ?></td>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
           ...
           <tr>
               ...
               <td>Min Score</td>
               <?php $__currentLoopData = $data['subject']->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <td><?php echo e(App\Student::min_score_CAT1($item->id,$data['class_']->id,$data['term']->id)); ?></td>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          ...
          <tr>
                        ...
                        <td>Class Average</td>
                        <?php $__currentLoopData = $data['subject']->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(App\Student::average_(App\Student::subject_total_CAT1($item->id,$data['class_']->id,$data['term']->id),$data['term']->id,$data['class_']->id,$item->id,2)); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td>Class Performance (%)</td>
                        <?php $__currentLoopData = $data['subject']->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(round(App\Student::average_per(App\Student::subject_total_CAT1($item->id,$data['class_']->id,$data['term']->id),($TCA_score  * App\Student::checkNoStudent($data['term']->id,$data['class_']->id,$item->id,2))))); ?></td>
                        <?php
                            $cl_av += App\Student::average_per(App\Student::subject_total_CAT1($item->id,$data['class_']->id,$data['term']->id),($TCA_score  * App\Student::checkNoStudent($data['term']->id,$data['class_']->id,$item->id,2)));
                        ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td>Remarks</td>
                        <?php $__currentLoopData = $data['subject']->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><?php echo e(App\Student::h_grade(App\Student::average_per(App\Student::subject_total_CAT1($item->id,$data['class_']->id,$data['term']->id),($TCA_score  * App\Student::checkNoStudent($data['term']->id,$data['class_']->id,$item->id,2))),$data['grades'])); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home/ishledpg/efs/resources/views/pdf/cat1_broadsheet.blade.php ENDPATH**/ ?>