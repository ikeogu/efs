    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php if(auth()->check() && auth()->user()->isAdmin == 1): ?>
                ...
                <!-- Nav Item - Charts -->
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('adm')); ?>">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="<?php echo e(route('USD')); ?>">Student Passwords</a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('broad2')); ?>">
                        <i class="fas fa-fw fa-setting-o"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('VC')); ?>">
                        <i class="fas fa-fw fa-setting-o"></i>
...
<?php /**PATH /home/chiboy/lampstack-8.0.5-0/apache2/htdocs/efs/resources/views/layouts/dashboard.blade.php ENDPATH**/ ?>